...
public class JsonInfoIndexServlet extends HttpServlet{
	// 获得数据库操作的DAO
	private UserDao userDao;
	/**
	 * Constructor of the object.
	 */
	public JsonInfoIndexServlet() {
		userDao = new UserDao();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * beanList （从数据库查询）
		 */
		System.out.println("----JSON-获取资料列明数据信息-----/r/n");
		try{
			// 获取前台表单提交后的用户名
	...
	//		map.put("page", page);
			...
			jsonReply = JSONObject.fromObject(infoIndex);
